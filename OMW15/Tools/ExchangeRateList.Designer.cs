namespace OMW15.Tools
{
	partial class ExchangeRateList
	{
		...
		private void InitializeComponent()
		{
			...
			this.lstCurrencyList = new System.Windows.Forms.ListBox();
			...
			this.panel2.Controls.Add(this.lstCurrencyList);
			...
			// lstCurrencyList
			// 
			this.lstCurrencyList.Dock = System.Windows.Forms.DockStyle.Top;
			this.lstCurrencyList.FormattingEnabled = true;
			this.lstCurrencyList.IntegralHeight = false;
			this.lstCurrencyList.ItemHeight = 17;
			this.lstCurrencyList.Location = new System.Drawing.Point(2, 32);
			this.lstCurrencyList.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.lstCurrencyList.Name = "lstCurrencyList";
			this.lstCurrencyList.Size = new System.Drawing.Size(121, 191);
			this.lstCurrencyList.TabIndex = 1;
			this.lstCurrencyList.SelectedIndexChanged += new System.EventHandler(this.lstCurrencyList_SelectedIndexChanged);
			// 
			// label1
			// 
		...
		private System.Windows.Forms.ListBox lstCurrencyList;

...
namespace OMW15.Views.Productions.ProductionReports {
    ...
    public class WorkByMonth : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "OMW15.Views.Productions.ProductionReports.WorkByMonth.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedWorkByMonth : Component, ICachedReport {
        
        public CachedWorkByMonth() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            WorkByMonth rpt = new WorkByMonth();
            rpt.Site = this.Site;
            return rpt;
        }

namespace OMW15.Views.CastingView
{
	partial class RBInfo
	{
		...
		private void InitializeComponent()
		{
			...
			// ntxtBaseWeight
			// 
			this.ntxtBaseWeight.AllowControl = true;
			this.ntxtBaseWeight.AllowDecimal = true;
			this.ntxtBaseWeight.AllowMultipleDecimals = true;
			this.ntxtBaseWeight.AllowNegation = true;
			this.ntxtBaseWeight.DecimalValue = new decimal(new int[] {
            0,
            0,
            0,
            131072});
			this.ntxtBaseWeight.Dock = System.Windows.Forms.DockStyle.Left;
			this.ntxtBaseWeight.IntegerValue = 0;

namespace OMW15.Views.ServiceView
{
	partial class MCInfo
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtCustomerFilter.EnabledChanged += new System.EventHandler(this.txtCustomerFilter_EnabledChanged);
			...
			this.txtSNFilter.EnabledChanged += new System.EventHandler(this.txtSNFilter_EnabledChanged);
			...
			this.cbxModel.EnabledChanged += new System.EventHandler(this.cbxModel_EnabledChanged);
			// 
			// chkModel
			// 
